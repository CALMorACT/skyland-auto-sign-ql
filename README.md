...
**参考项目**:
[Gitee 源项目](https://gitee.com/FancyCabbage/skyland-auto-sign)
[README](https://github.com/sjtt2/endfield_auto_sign)
[签到代码](https://github.com/AdiEcho/skyland-auto-sign-ql)
...
| :--- | :--- |
| 名称 | `森空岛签到` |
| 地址 | `https://github.com/CALMorACT/skyland-auto-sign-ql` |
| 分支 | `master` |
| 定时 | `0 0 23 * * *` |
...
2. 访问这个[网址](https://web-api.skport.com/cookie_store/account_token)
